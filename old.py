# this is legacy code and will not work under the current setup of the
# venv
import pandas as pd
import numpy as np
...
ph3 = Path(
    r"/home/tauras/Desktop/Point0000_ChannelmCardinal_Ph-3_Seq0000_s1_acdc_output.csv"
)
mito = Path(
    r"/home/tauras/Desktop/Point0000_ChannelmCardinal_Ph-3_Seq0000_s1_run_num1_mCardinal_ref_ch_acdc_output_mask_mitoacdc_outputentation.csv"
)
df1 = pd.read_csv(ph3)
...
end_s = s_df.sort_values("frame_i").groupby("Cell_ID").last().reset_index()
...
buds = buds.rename(
    columns={"Cell_ID": "bud_Cell_ID", "mito_to_cell_ratio": "mito_to_cell_ratio_bud"}
)


mothers = mothers[["mother_Cell_ID", "mother_generation", "mito_to_cell_ratio_mother"]]


mother_bud_table = buds.merge(
    mothers, left_on="relative_ID", right_on="mother_Cell_ID", how="left"
)
